...
TapFrenzy is a robust, multi-game iOS application built purely in SwiftUI. It provides an engaging suite of mini-games alongside comprehensive statistics tracking, interactive map plotting for played sessions, and a daily local notification system.
